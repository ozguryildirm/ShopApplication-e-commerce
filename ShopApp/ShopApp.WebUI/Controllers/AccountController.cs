...
{
    [AutoValidateAntiforgeryToken] //güvenlik için.Kullanıcı başka bir token a sahipse işlem yapamaz. Get hariç tüm actionlar için geçerli
    public class AccountController : Controller
    {
        ...
        public async Task<IActionResult> Register(RegisterModel model)
        {
            ...
            if (result.Succeeded)
            {
                ...
                // send email
                await _emailSender.SendEmailAsync(model.Email, "Hesabınızı onaylayınız.", $"Lütfen email hesabınızı onaylamak için linke <a href='http://localhost:53113{callbackUrl}'>tıklayınız.<a/>");
        ...
        public async Task<IActionResult> Logout()
        {
            ...
            return Redirect("~/"); //directing to homepage
        }
        ...
        public async Task<IActionResult> ForgotPassword(string Email)
        {
            ...
            // send email
            await _emailSender.SendEmailAsync(Email, "Reset Password", $"Parolanızı yenilemek için linke <a href='http://localhost:53113{callbackUrl}'>tıklayınız.<a/>");
